...
class FeedBackDlg(Toplevel):
    ...
    def initUI(self):
        ...
        self.chkElectronics = Checkbutton(self, text="Electronics", variable=self.electronicsChoice)  # ,command=self.chkElectronicsChanged)
    ...
    def btnSubmitClick(self):
        print("electronics = " + str(self.electronicsChoice.get()) + " sports=" + str(self.sportsChoice.get()) + " gardening=" + str(self.gardeningChoice.get()))
